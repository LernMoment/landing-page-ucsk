#!/bin/bash
# Skript zum Deployment von einstieg-in-csharp.LernMoment.de - wird auf dem Server ausgeführt!
...
SITE=einstieg-in-csharp
SITE_NEW=_site
SITE_PREVIOUS=ucsk-lp-old

# Informationen für Staging
STAGING_ZIPPED_SITE=ucsk_lp-site-staging2.tgz
STAGING_SERVER_AREA=~/staging2

# Informationen für Production
PRODUCTION_ZIPPED_SITE=ucsk_lp-site-production.tgz
